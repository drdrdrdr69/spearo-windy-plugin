...
- Panel for any point on the map (`desktopUI: rhpane`, `mobileUI: small` — the map
  stays visible on phones): **water visibility (m)**, **wave**, **wind**,
  **water temperature**, **tide** and a **safety verdict** for today and tomorrow.
